...
##plot time
##plot [1,1]
plot(rel_data$DateTime, rel_data$Global_active_power, type="l")

##plot [1,2]
plot(rel_data$DateTime, rel_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
##plot [2,2]
rel_data$Global_reactive_power <- as.numeric(as.character(rel_data$Global_reactive_power))
plot(rel_data$DateTime, rel_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
